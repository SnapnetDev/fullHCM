                  ...
                  <table id="atttable" class="table table-striped" >
					...
					@if(count($attendances)>0)
                     ...
                     <tr>
						...
						<b>{{date('D dS M, Y @ h:i:s a',strtotime($date.$attendance['first_clock_in']))}}</b>
						</span>
                        </td>
                        <td class="hidden-sm-down">
						
                        <span class="text text-danger">
						<b>@if($attendance['first_clock_out']=="" ||$attendance['first_clock_out']==$attendance['first_clock_in']) {{__('Nill')}} @else {{$attendance['spills']==1?date('D dS M, Y @ h:i:s a',strtotime($date.$attendance['first_clock_out']. "+1 day")):date('D dS M, Y @ h:i:s a',strtotime($date.$attendance['first_clock_out']))}} @endif</b>
					   </span>
                        </td>
						<td>
