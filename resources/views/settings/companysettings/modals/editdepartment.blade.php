<div class="modal fade in modal-3d-flip-horizontal modal-info" id="editDepartmentModal" aria-hidden="true" aria-labelledby="editDepartmentModal" role="dialog" tabindex="-1">
