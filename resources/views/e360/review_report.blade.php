          ...
          <div class="col-md-12">
            ...
            <div class="panel panel-info ">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Employee review - {{$employee->name}} for {{date('F-Y',strtotime($det->measurement_period->from))}} to {{date('F-Y',strtotime($det->measurement_period->to))}}</h3>
