...
<div class="page ">
    <div class="page-header">
      <h1 class="page-title">360 Review Department Template</h1>
          ...
          <div class="col-md-12">
            ...
            <div class="panel panel-info ">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">360 Review Question Template for {{$det->department->name}} for {{date('F-Y',strtotime($det->measurement_period->from))}} to {{date('F-Y',strtotime($det->measurement_period->to))}}</h3>
              ...
              <div class="panel-body">
                ...
                @foreach($det->questions as $question)
                 <table class="table table-striped">
                  <tr>
                    <th width="90%">{{$question->question}}</th>
                    <th width="10%">
                      <button type="button"  class="btn btn-info   btn-sm  questionbtn" id="{{$question->id}}" data-toggle="modal" data-target="#editSubjectModal" ><i class="fa fa-pencil" aria-hidden="true"></i></button>
