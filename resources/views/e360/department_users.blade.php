              ...
              <table class="table table-striped" id="userstable">
                ...
                <tbody>
                  ...
                  @foreach ($det->department->users as $user)
                    ...
                    <td><span class=" tag   
                      {{Auth::user()->myreviews->where('e360_det_id',$det->id)->contains('user_id', $user->id)?'tag-success':'tag-warning'}}">
                      {{Auth::user()->myreviews->where('e360_det_id',$det->id)->contains('user_id', $user->id)?'Yes':'No'}}</span></td>
