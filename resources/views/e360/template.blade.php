...
<div class="page ">
    <div class="page-header">
      <h1 class="page-title">Review 360 Department Template</h1>
          ...
          <div class="col-md-12">
            ...
            <div class="panel panel-info ">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title">Department Review Questions</h3>
              </div>
              <form action="{{ url('e360settings/get_det') }}" method="GET">
