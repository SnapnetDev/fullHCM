...
<div class="page ">
    <div class="page-header">
      <h1 class="page-title">Review 360 Employee Review</h1>
...
<script type="text/javascript" src="{{ asset('global/vendor/bootstrap-datepicker/bootstrap-datepicker.min.js')}}"></script>
 ...
 Survey
    ...
    @php
      $per_page=5;
      $questions_count=count($det->questions);
    @endphp
var json = {
    pages: [
        {
    ...
    .add(function (result) {
        ...
        //     .innerHTML = "result: " + JSON.stringify(result.data);
            $.ajax({
                type: 'POST',
                url: '{{url('e360')}}',
                data: {result: result.data,type:'save_evaluation',_token:"{{csrf_token()}}",det_id:{{$det->id}},evaluation_id:{{$evaluation->id}} }
            })
            .done( function( data ) {
                console.log('done');
                console.log(data);
